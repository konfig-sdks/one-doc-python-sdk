...
class RequiredDocumentGeneratePdfFromBucketRequest(TypedDict):
    pass

class OptionalDocumentGeneratePdfFromBucketRequest(TypedDict, total=False):
...
class DocumentGeneratePdfFromBucketRequest(RequiredDocumentGeneratePdfFromBucketRequest, OptionalDocumentGeneratePdfFromBucketRequest):
    pass
